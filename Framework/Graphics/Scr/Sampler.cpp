...
namespace
{
	...
	D3D11_TEXTURE_ADDRESS_MODE GetAddressMode(Sampler::AdressMode adressMode)
	{
		switch (adressMode)
		{
		case Sampler::AdressMode::Border:
			return D3D11_TEXTURE_ADDRESS_BORDER;
		case Sampler::AdressMode::Clamp:
			return D3D11_TEXTURE_ADDRESS_CLAMP;
		case Sampler::AdressMode::Mirror:
			return D3D11_TEXTURE_ADDRESS_MIRROR;
		case Sampler::AdressMode::Wrap:
